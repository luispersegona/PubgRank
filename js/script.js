const commandsData = {
  category1: {
    ...
    commands: [
      ...
      {
        name: "/showlink",
        description: "Mostra o link do usuário do discord com o PUBG",
        permission: "Admin",
      },
      {
        name: "/unlinkpubg",
        description: "Remove o link do usuário do discord com o PUBG",
        permission: "Admin",
      },
      {
        name: "/limpar",
  ...
  category3: {
    ...
    commands: [
      ...
      {
        name: "/reportar",
        description: "Envia um report/feedback do bot para os administradores",
        permission: "Membro",
      },
    ],
  },
